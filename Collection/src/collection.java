...
public class collection {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			tree.add(new employee(24,"Abhay","ECE",30000));
			tree.add(new employee(21,"Sourabh","CE",40000));
			tree.add(new employee(19,"Shubham","CSE",40000));
		...
		case 2:
			...
			tree1.add(new employee(21,"Shubham","CE",40000));
		...
		case 3:
			...
			tree2.add(new employee(21,"Shubham","CE",40000));
		...
		case 4:
			...
			tree3.add(new employee(21,"Shubham","CE",40000));
